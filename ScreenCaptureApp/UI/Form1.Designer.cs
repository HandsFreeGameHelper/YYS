...
namespace ScreenCaptureApp.UI
{
  partial class Form1
  {
    ...
    private void InitializeComponent()
    {
      ...
      comboBox1.Items.AddRange(new object[] { "", "普通副本", "活动爬塔", "突破" });
      ...
      comboBox2.Items.AddRange(new object[] { "", "个人", "阴阳寮", "觉醒副本任意层", "御灵任意层", "八岐大蛇1-10层", "八岐大蛇11层", "八岐大蛇12层", "卑弥呼1层", "卑弥呼2层", "卑弥呼3层", "业原火贪", "业原火嗔", "业原火痴", "永生之海1层", "永生之海2层", "永生之海3-4层", "黄金夜航-藏金阁楼-活动室", "黄金夜航-藏金阁楼-战术厅", "黄金夜航-藏金阁楼-船员室", "黄金夜航-藏金阁楼-黄金阁" });
